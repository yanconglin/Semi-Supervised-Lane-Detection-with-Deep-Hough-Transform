...
parser.add_argument('--thres', default=0.9, type=float, metavar='M', help='confidence thres (useful on semi)')
...
parser.add_argument('--resume', default='pretrained/ERFNet_pretrained.tar', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')

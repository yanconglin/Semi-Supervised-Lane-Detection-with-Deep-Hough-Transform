...
% Data root
data = '/tudelft.net/staff-bulk/ewi/insy/VisionLab/yanconglin/dataset/lanes/CULane';
% Directory where prob imgs generated by CNN are saved.
probRoot = strcat('/tudelft.net/staff-bulk/ewi/insy/VisionLab/yanconglin/lanes/ERFNet-CULane/predicts/', exp);

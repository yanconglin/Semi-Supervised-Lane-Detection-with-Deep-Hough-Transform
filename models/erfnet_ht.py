...
from models.HT import CAT_HTIHT
...
class ERFNet_HT(nn.Module):
    def __init__(self, num_classes, device=None):
        ...
        vote_index["26_122"]=vote_index_26_122
        print('vote_index', vote_index_26_122.shape)
        #
        # name = "vote_index_52_244_3_3.mat"
        # vote_index_52_244 = sio.loadmat(name)['vote_index']
        # vote_index_52_244 = torch.from_numpy(vote_index_52_244).float().contiguous()
        # vote_index_26_122.requires_grad=False
        # vote_index_52_244 = vote_index_52_244.to(device)
        # vote_index["52_244"]=vote_index_52_244
        # print('vote_index', vote_index_52_244.shape)
        ...
        self.ht=CAT_HTIHT(vote_index["26_122"], inplanes=128, outplanes=16)
